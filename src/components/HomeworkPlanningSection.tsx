    ...
    <Card className="bg-card shadow-md animate-fade-in-up">
      ...
      <CardContent>
        <p className="mb-4 text-muted-foreground">
          Спочатку оберемо тему для твого сайту. Це може бути що завгодно: твій улюблений герой, хобі, домашній улюбленець або навіть твоя сім'я! Цей розділ допоможе тобі спланувати структуру сайту, який ти будеш створювати на своїй навчальній платформі Logika.
        </p>
