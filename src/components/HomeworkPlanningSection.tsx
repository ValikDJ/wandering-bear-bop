    ...
    <Card className="bg-card shadow-md animate-fade-in-up">
      ...
      <CardContent>
        <p className="mb-4 text-muted-foreground">
          Спочатку оберемо тему для твого сайту. Це може бути що завгодно: твій улюблений герой, хобі, домашній улюбленець або навіть твоя сім'я!
        </p>
          ...
          <CollapsibleContent className="data-[state=open]:animate-collapsible-down data-[state=closed]:animate-collapsible-up overflow-hidden">
            <div className="p-4 border border-border rounded-b-md bg-muted mt-2 text-muted-foreground">
              ...
              <ul className="list-disc list-inside">
                <li>**Вступ:** Хто/що це? Чому це важливо для тебе?</li>
                <li>**Деталі:** Опиши особливості, цікаві факти.</li>
                <li>**Історія:** Як це з'явилося?</li>
                <li>**Галерея:** Якщо є багато картинок.</li>
                <li>**Контакти/Посилання:** Якщо це про щось, де можна дізнатися більше.</li>
              </ul>
