      ...
      case 'robot':
        return (
          <svg className={`${baseClasses}`} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="20" y="20" width="60" height="60" rx="10" fill="#60A5FA"/>
            <circle cx="40" cy="40" r="5" fill="#fff"/>
            <circle cx="60" cy="40" r="5" fill="#fff"/>
            <rect x="35" y="60" width="30" height="5" rx="2" fill="#fff"/>
            <rect x="30" y="10" width="5" height="10" fill="#60A5FA"/>
            <rect x="65" y="10" width="5" height="10" fill="#60A5FA"/>
          </svg>
        );
      case 'cat':
        return (
          <svg className={`${baseClasses}`} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="50" cy="55" r="35" fill="#FDBA74"/>
            <path d="M30 40 L40 20 L50 40 Z" fill="#FDBA74"/>
            <path d="M70 40 L60 20 L50 40 Z" fill="#FDBA74"/>
            <circle cx="42" cy="50" r="3" fill="#fff"/>
            <circle cx="58" cy="50" r="3" fill="#fff"/>
            <path d="M50 60 Q45 65 50 70 Q55 65 50 60 Z" fill="#fff"/>
            <line x1="40" y1="55" x2="30" y2="50" stroke="#333" strokeWidth="1"/>
      ...
      case 'owl':
        return (
          <svg className={`${baseClasses}`} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M50 55 L45 65 L55 65 Z" fill="#FBBF24"/>
            <path d="M30 25 Q40 15 50 25 Q60 15 70 25" stroke="#333" strokeWidth="2" fill="none"/>
          </svg>
        );
      default:
        return null;
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end">
      ...
      <div className={cn(
        ...
        displayMessage ? "opacity-100" : "opacity-0 pointer-events-none"
      )}>
