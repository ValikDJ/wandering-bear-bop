...
const initialChecklist: Omit<ChecklistItem, 'completed'>[] = [
  ...
  { id: "8", text: "Я додав хоча б 2 картинки і вказав для них <code>src</code> та <code>alt</code>." },
  { id: "9", text: "Я замінив 'ТВОЄ ІМ'Я' на своє ім'я у підвалі сайту." },
  { id: "10", text: "Я перевірив, чи всі посилання (<code>&lt;a&gt;</code>) працюють (натиснув на них)." },
  { id: "11", text: "Я перевірив, чи всі картинки (<code>&lt;img&gt;</code>) відображаються." },
