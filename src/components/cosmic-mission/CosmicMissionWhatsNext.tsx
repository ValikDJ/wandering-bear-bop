  ...
  return (
    <Card className="mb-12 bg-card shadow-md">
      ...
      <CardContent>
        ...
        <p className="mb-4 text-muted-foreground">
          Але це лише початок твоєї подорожі! Наступного разу ми вирушимо до ще більш захопливих зіркових систем, де навчимося робити твою космічну базу ще більш інтерактивною та динамічною за допомогою **JavaScript** — мови, яка оживляє веб-сторінки!
        </p>
